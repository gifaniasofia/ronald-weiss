export const Hero = () => {
  return (
    <div className='relative z-20 isolate overflow-hidden lg:aspect-[1440/1331] min-h-screen'>
      <div className='relative w-full h-screen container-center'>
        <div className='pt-60 pb-14 lg:pt-0 absolute bottom-0 z-10 flex flex-col items-center space-y-10 sm:space-y-16'>
